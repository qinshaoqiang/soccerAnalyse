...
path = '/ai_football/zc_demo/tmp/soccer/xdat/'
data = pd.read_csv(path + 'xdat2017.dat', dtype=str, encoding='gb18030', index_col='gid')
...
tmp.to_csv(path + '20180804_odd_subtttt33344.csv', index=False)
